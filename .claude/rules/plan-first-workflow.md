...
**When to use:**
- Task is high-level or vague ("improve the agent", "optimize performance")
...
4. Declare clarity status: **CLEAR** / **ASSUMED** / **BLOCKED**
5. Get user approval on spec
6. THEN proceed to Step 4 (draft the plan)
...
**After Compression:**
First message: "Resuming after compression. Last task: [read plan + git log]. Status: [next step]."
