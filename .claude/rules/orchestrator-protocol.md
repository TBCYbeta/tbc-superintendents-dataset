...
Plan approved -> orchestrator activates
  ...
  |
  Step 2: VERIFY -- Run tests, linter, check outputs
...
|---------------|----------------|
| `*.py` source | code-reviewer |
| `tests/*.py` | test-reviewer |
| Agent prompt / domain logic | domain-reviewer |
| Disambiguation output (CSV) | disambiguation-critic |
| Any changes | verifier |
